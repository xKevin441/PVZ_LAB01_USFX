...
// Cross Module References
	PVZ_LAB01_USFX_API UClass* Z_Construct_UClass_ASol_NoRegister();
	PVZ_LAB01_USFX_API UClass* Z_Construct_UClass_ASol();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_PVZ_LAB01_USFX();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	PVZ_LAB01_USFX_API UClass* Z_Construct_UClass_URandomMovement_NoRegister();
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SolMesh_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SolMesh;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASol_Statics::NewProp_SolMesh_MetaData[] = {
		{ "Category", "Sol" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Sol.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASol_Statics::NewProp_SolMesh = { "SolMesh", nullptr, (EPropertyFlags)0x0010000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASol, SolMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASol_Statics::NewProp_SolMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASol_Statics::NewProp_SolMesh_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASol_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASol_Statics::NewProp_SolMesh,
	...
	IMPLEMENT_CLASS(ASol, 1818183741);
	template<> PVZ_LAB01_USFX_API UClass* StaticClass<ASol>()
	{
		return ASol::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASol(Z_Construct_UClass_ASol, &ASol::StaticClass, TEXT("/Script/PVZ_LAB01_USFX"), TEXT("ASol"), false, nullptr, nullptr, nullptr);
